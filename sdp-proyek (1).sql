...
INSERT INTO `auth_perusahaan` (`perusahaan_id`, `perusahaan_nama`, `perusahaan_email`, `perusahaan_password`, `perusahaan_alamat`, `perusahaan_kota`, `perusahaan_kodepos`, `perusahaan_telp`, `perusahaan_tipe`, `perusahaan_npwp`, `perusahaan_status`, `perusahaan_rate`, `perusahaan_profPic`, `perusahaan_verification_hash`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `project_pekerja` (
  ...
  `user_id` varchar(50) NOT NULL,
  `project_id` varchar(50) NOT NULL,
  `project_pekerja_status` int(1) NOT NULL DEFAULT 0,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
