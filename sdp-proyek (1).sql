...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2020 at 03:02 PM
...
CREATE TABLE `auth_perusahaan` (
  ...
  `perusahaan_kota` varchar(255) NOT NULL,
...
INSERT INTO `auth_perusahaan` (`perusahaan_id`, `perusahaan_nama`, `perusahaan_email`, `perusahaan_password`, `perusahaan_alamat`, `perusahaan_kota`, `perusahaan_kodepos`, `perusahaan_telp`, `perusahaan_tipe`, `perusahaan_npwp`, `perusahaan_status`, `perusahaan_rate`, `perusahaan_profPic`, `created_at`, `updated_at`) VALUES
...
('PE_5e95b0c906333', 'Toko Satu Jiwa', 'ansell08.es@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'Pondok Tjandra Indah', 'Surabaya Utara', '62156', '1231232312', 'CV', 'asset/upload/npwp-company/263822.jpg', '0', 4, 'asset/img/profile/1996cc39b9077a22ff2490738da876d61.jpg', '2020-04-14 14:47:05', '2020-04-14 14:47:05'),
...
INSERT INTO `auth_user` (`user_id`, `user_firstname`, `user_lastname`, `user_email`, `user_username`, `user_password`, `user_alamat`, `user_kota`, `user_kodepos`, `user_ktp`, `user_status`, `user_rate`, `user_verification_code`, `user_cv`, `user_profile`, `updated_at`, `created_at`) VALUES
('US_5ea5b23f458ef', 'dummy', 'user', 'dominatorranger@gmail.com', 'dummyuser', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'tengger', 'surabaya-barat', '60199', 'asset/upload/ktp-user/8d979fd59d0224511fcd8c63c12fafce.png', 0, 5, '390d2e108d50f7bdd2c8df39ceb978a5', 'asset/upload/cv-user/e2689ea14ea3b28d4d6b07eb668f64901.png', 'asset/upload/pp-user/7440fcb057c80f75b59eda736e29e1a01.jpg', '2020-05-04 12:54:11', '2020-04-26 18:09:35'),
('US_5ea5b23f458eg', 'dummy', 'user2', 'dominatorranger@gmail.com', 'dummyuser2', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'tengger', 'surabaya-barat', '60199', 'asset/upload/ktp-user/8d979fd59d0224511fcd8c63c12fafce.png', 0, 0, '390d2e108d50f7bdd2c8df39ceb978a5', 'asset/upload/cv-user/3b2eb9018bc055b9ddf30e8ee136e9f9.png', 'asset/upload/pp-user/68422cef3e99150985813813b48326b4.png', '2020-05-04 13:26:14', '2020-04-26 18:09:35');
...
('Buat5ea8ed0b0be46', 'PE_5e95b0c906333', '1', 'jasa5e68fc00dbf9f', 'Buat Web', 'Buat web', '150000', '2', '2020-04-29 00:00:00', '2020-04-30 00:00:00', '2042-02-03 00:00:00', '2042-02-03 00:00:00'),
('Buat5eb004c628fc4', 'PE_5e95b0c906333', '1', 'teknologi informatika5e69a63ba', 'Buat Web Company', 'Bisa Framework dan mampu bekerja di bawah tekanan', '200000', '0', '2020-05-22 00:00:00', '2020-07-17 00:00:00', '2052-02-01 00:00:00', '2052-02-01 00:00:00'),
('Jaga5ea5b944af6ec', 'PE_5e95b0c906333', '1', 'jasa5e68fc00dbf9f', 'Jaga Toko', 'Jaga toko saya selama 2 jam', '50000', '1', '2020-04-04 00:00:00', '2020-04-30 00:00:00', '0000-00-00 00:00:00', '2020-04-29 04:47:38'),
('jaga5eaffc30e5f7d', 'PE_5e95b0c906333', '1', 'jasa5e68fc00dbf9f', 'jaga toko harian', 'Mampu bersikap ramah dan disiplin', '100000', '0', '2020-05-30 00:00:00', '2020-06-17 00:00:00', '2052-02-01 00:00:00', '2052-02-01 00:00:00'),
('Kurir5eb13dbd00a29', 'PE_5e95b0c906333', '1', 'jasa5e68fc00dbf9f', 'Kurir Pengiriman', 'Punya SIM, dan bisa menghafal jalan dengan baik', '50000', '0', '2020-05-19 00:00:00', '2020-06-16 00:00:00', '2052-02-02 00:00:00', '2052-02-02 00:00:00');
...
--
-- Dumping data for table `project_subkategori`
--

INSERT INTO `project_subkategori` (`project_subkategori_id`, `sub_kategori_id`, `project_id`, `created_at`, `updated_at`) VALUES
('jaga toko5e77207f499eb5eb13dbd00a4d', 'jaga toko5e77207f499eb', 'Kurir Pengiriman5eb13dbd00a50', '2052-02-02 00:00:00', '2052-02-02 00:00:00'),
('Web Developer5eb001a6323ab5eb004c628fd2', 'Web Developer5eb001a6323ab', 'Buat Web Company5eb004c628fd3', '2052-02-01 00:00:00', '2052-02-01 00:00:00');
...
CREATE TABLE `review_perusahaan` (
  ...
  `perusahaan_id` varchar(50) NOT NULL,
  `review_perusahaan_deskripsi` text NOT NULL,
  `review_perusahaan_rating` int(1) NOT NULL,
  `review_perusahaan_by` varchar(255) NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `review_perusahaan`
--

INSERT INTO `review_perusahaan` (`review_perusahaan_id`, `perusahaan_id`, `review_perusahaan_deskripsi`, `review_perusahaan_rating`, `review_perusahaan_by`, `created_at`, `updated_at`) VALUES
('RTPE_5e95b0c9063335eb1639606aa2', 'PE_5e95b0c906333', 'Cukup Memuaskan', 4, 'US_5ea5b23f458ef', '2052-02-02 00:00:00', '2052-02-02 00:00:00');
...
CREATE TABLE `review_user` (
  ...
  `review_user_by` varchar(255) NOT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `review_user` (`review_user_id`, `user_id`, `review_user_deskripsi`, `review_user_rating`, `review_user_by`, `created_at`, `updated_at`) VALUES
('RTUS_5ea5b23f458ef5eb15c5254b03', 'US_5ea5b23f458ef', 'Orangnya totalitas', 5, 'PE_5e95b0c906333', '2052-02-02 00:00:00', '2052-02-02 00:00:00'),
('RTUS_5ea5b23f458ef5eb15c684ba04', 'US_5ea5b23f458ef', 'Orangnya totalitas', 5, 'PE_5e95b0c906333', '2052-02-02 00:00:00', '2052-02-02 00:00:00');
...
('Microsoft5eb001af5e8f3', 'teknologi informatika5e69a63ba', 'Microsoft', '2052-02-01 00:00:00', '2052-02-01 00:00:00'),
('Pengajar5eb0019d251f6', 'pendidikan5e6891103daee', 'Pengajar', '2052-02-01 00:00:00', '2052-02-01 00:00:00'),
('Web Developer5eb001a6323ab', 'teknologi informatika5e69a63ba', 'Web Developer', '2052-02-01 00:00:00', '2052-02-01 00:00:00');
...
CREATE TABLE `sub_project` (
  ...
  `sub_project_finished_by` varchar(255) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `sub_project` (`sub_project_id`, `project_id`, `sub_project_name`, `sub_project_deadline`, `sub_project_status`, `sub_project_finished_by`, `created_at`, `updated_at`) VALUES
('buat5ea2fefce4f1c', 'buat5ea2e72eb4246', 'buat mock up', '2020-05-01 00:00:00', 1, NULL, '2042-02-05 00:00:00', '2020-04-24 17:28:03'),
('buat5ea2ff7cba03b', 'buat5ea2e72eb4246', 'buat tampilan dan design', '2020-05-15 00:00:00', 0, NULL, '2042-02-05 00:00:00', '2020-04-24 17:32:04'),
('buat5ea5b9867c83b', 'Jaga5ea5b944af6ec', 'buat laporan keuangan', '2020-04-26 00:00:00', 1, 'US_5ea5b23f458ef', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
('buat5ea5ba09eb738', 'Jaga5ea5b944af6ec', 'buat laporan keuangan lagi', '2020-04-26 00:00:00', 1, 'US_5ea5b23f458ef', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
('buat5ea8ed82e263f', 'Buat5ea8ed0b0be46', 'buat laporan keuangan', '2020-04-29 00:00:00', 1, NULL, '2042-02-03 00:00:00', '2042-02-03 00:00:00'),
('buat5ea8ed935cd1f', 'Buat5ea8ed0b0be46', 'buat laporan keuangan lagi', '2020-04-30 00:00:00', 1, NULL, '2042-02-03 00:00:00', '2042-02-03 00:00:00'),
('laporan5eb137c8d5255', 'Jaga5ea5b944af6ec', 'laporan pajak', '2020-05-13 00:00:00', 1, 'US_5ea5b23f458eg', '2052-02-02 00:00:00', '2052-02-02 00:00:00');
