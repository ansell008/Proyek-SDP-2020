...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2020 at 07:06 AM
...
CREATE TABLE `auth_perusahaan` (
  ...
  `perusahaan_profPic` varchar(255) NOT NULL DEFAULT 'base_url().''asset/img/profile/profile.png',
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `auth_perusahaan` (`perusahaan_id`, `perusahaan_nama`, `perusahaan_email`, `perusahaan_password`, `perusahaan_alamat`, `perusahaan_telp`, `perusahaan_tipe`, `perusahaan_npwp`, `perusahaan_status`, `perusahaan_rate`, `perusahaan_profPic`, `created_at`, `updated_at`) VALUES
...
('PE_5e8731f769074', 'Toko Camilan Surabaya', 'ansell08.es@gmail.com', '123456', 'Pondok Tjandra Indah', '123456789', 'CV', '123456789', '0', 0, 'asset/img/profile/263822.jpg', '2020-04-03 14:54:15', '2020-04-03 14:54:15');
...
('pr_002', '1', '2', 'jasa5e68fc00dbf9f', 'kasir', 'Menjaga keuangan toko selama 6 jam/hari untuk 2 hari', '1540000 / 2 hari', '1', '2020-03-23 00:00:00', '2020-03-27 00:00:00', '2020-03-22 00:00:00', '2020-03-22 00:00:00');
